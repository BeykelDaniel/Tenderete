...
<nav id="sidebar-desktop"
    ...
    <ul id="nav-lista-desktop" class="w-full flex flex-col items-start px-8 gap-y-8 font-black text-[#32424D] text-lg">
        ...
        <li class="w-full">
            <a href="{{ route('pagina.amigos') }}" class="hover:text-[#C2841D] transition-colors flex items-center gap-4 w-full uppercase hover:translate-x-2 text-xl">
               <i class="bi bi-people-fill text-xl"></i> Mis Amigos
            </a>
        </li>
        
        <!-- MIS ACTIVIDADES - Componente Vue -->
        <li class="w-full hover:translate-x-2 ">
            <calendario-navbar 
        ...
        <li class="w-full mt-auto pt-6 border-t border-[#32424D]/20">
            <a href="{{ route('profile.edit') }}" class="hover:text-[#C2841D] transition-colors flex items-center gap-4 w-full uppercase hover:translate-x-2 text-xl">
        ...
        <li class="w-full mb-8 pt-4 hover:translate-x-2 ">
        ...
        @else
        <li class="w-full mt-auto pt-8 border-t border-[#32424D]/20 mb-8 hover:translate-x-2 ">
