                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 font-medium">{{
                                        $usuario->name }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $usuario->email }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                        {{ $usuario->fecha_nacimiento ?
                                        \Carbon\Carbon::parse($usuario->fecha_nacimiento)->format('d/m/Y') : 'N/A' }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{
                                        $usuario->numero_telefono }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 italic">{{
                                        ucfirst($usuario->genero) }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
