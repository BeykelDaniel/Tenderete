    ...
    <div class="p-4 rounded-xl border border-gray-100 flex flex-col hover:border-[#82aeb4] transition-all bg-white shadow-sm">
        ...
        <div class="mt-auto flex justify-between items-end">
            <div class="flex flex-col gap-1.5">
                ...
                <button data-actividad='@json($a)' class="btn-ver-inscritos text-[10px] text-indigo-600 font-bold uppercase hover:text-indigo-800 hover:bg-indigo-100 transition-colors bg-indigo-50 px-3 py-1 rounded w-fit border border-indigo-100 shadow-sm flex items-center gap-1">
